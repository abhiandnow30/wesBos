...
const userId = '226a5a44-25a2-4f50-97b7-0c12411541fc';

function testJWTSigning() {
    try {
        console.log('🔐 Testing JWT signing with RS256...');
        ...
        // Verify the token can be decoded (without verification for testing)
...
module.exports = { testJWTSigning, privateKey };
